          ...
          <Box sx={{ display: 'flex', gap: 3, mt: 1 }}>
            ...
            >
              <Tab
                ...
                defaultChecked
                sx={{
                  fontWeight: '700', backgroundColor: tabValue === 'my1' ? '#0766AD' : 'default',
                  color: tabValue === 'my1' ? '#000000' : '#000000', borderTopLeftRadius: 5, borderTopRightRadius: 5
                }}
              />
              ...
              <Tab
                ...
                label='my2'
                sx={{
                  fontWeight: '700', backgroundColor: tabValue === 'my2' ? '#0766AD' : 'default',
                  color: tabValue === 'my2' ? '#000000' : '#000000', borderTopLeftRadius: 5, borderTopRightRadius: 5
                }}
              />
